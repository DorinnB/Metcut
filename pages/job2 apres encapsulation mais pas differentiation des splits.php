...
contenuOnglet<?php echo $splitencours; ?>-0<br/>
contenuOnglet<?php echo $splitencours; ?>-1	 
		<div id="contenuOnglet<?php echo $splitencours; ?>-0" style="display:none;">	  
		...
		entre 2
		<div id="contenuOnglet<?php echo $splitencours; ?>-1" style="display:block;">
