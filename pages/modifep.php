...
if(isset($_POST['modif']) AND isset($_POST['nom_eprouvette']) AND $_POST['nom_eprouvette']!="")	{
	...
	$modifep='UPDATE eprouvettes SET
...
$req_ep = mysql_query("SELECT eprouvettes.id_eprouvette, prefixe, nom_eprouvette, temperature, n_essai, frequence, rapport, deltaepsilon, epsilonmax, niveau_max, niveau_moy, niveau_alt, niveau_min, cycle_min, id_job, n_fichier, machine, DATE_FORMAT( enregistrementessais.date, '%d %b %Y' ) AS date, technicien, assigne
FROM eprouvettes
