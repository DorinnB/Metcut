							...
							<?php
								if ($checked!=1)	{	?>							
									<li style="float:right;">
										<a href="#"  id="myBtn" onclick="document.getElementById('ajoutsplit').submit();" class="toolbar">Ajout de la sous traitance</a>
									</li>
									<li  style="float:right;">
								...
								<table class="datajob" >
									<tbody>
										...
										<tr>
											...
											<td style="width: 23%; padding: 0px 0px 0px 10px;" class="colored">	<!--pricing-->
