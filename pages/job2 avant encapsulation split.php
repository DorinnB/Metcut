...
$req_split = $db->query("SELECT id_tbljob, id_statuts, customer, job, split, type_essai FROM tbljobs LEFT JOIN type_essais ON type_essais.id_type_essai=tbljobs.id_type_essai WHERE job=(select job from tbljobs where id_tbljob=".$_GET['id_job'].");");
...
<div id="contenuSplit1" style="display:none;">	<!--split 1-->

	<div id="menu">
	  <ul id="onglets">
		<li><a><span onclick="changeOnglet(0)">&nbsp;&nbsp;   Données du job  &nbsp;&nbsp;</span></a></li>
		<li><a><span onclick="changeOnglet(1)">&nbsp;&nbsp;  Eprouvettes  &nbsp;&nbsp;</span></a></li>
	  </ul>
	</div>
...
<div id="contenuSplit2" style="display:none;">
</div>
<div id="contenuSplit3" style="display:none;">
</div>
<div id="contenuSplit4" style="display:none;">
</div>
<div id="contenuSplit5" style="display:none;">
</div>